    ...
    <footer className="bg-gray-800 text-white pt-12 pb-6">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-bold mb-4">Central-M</h3>
            <p className="text-gray-400 mb-4">
              The modern marketplace for everyone to buy and sell products easily and securely.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/create-listing" className="text-gray-400 hover:text-white transition">
                  Sell
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <a
                  href="mailto:support@central-m.com"
                  className="text-gray-400 hover:text-white transition"
                >
                  support@central-m.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 pt-6">
          <p className="text-gray-400 text-center">
            &copy; {new Date().getFullYear()} Central-M. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
