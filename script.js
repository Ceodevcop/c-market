...
/*document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        Pi.init({
            version: "2.0",
            sandbox: true, // Set to `true` for sandbox/testing environment
            ...
            try {
                ...
                Pi.createPayment(paymentData, {
                    ...
                    onReadyForServerApproval: (paymentId) => {
                        ...
                        // Send paymentId to Vercel serverless function for approval
                        fetch('/api/approve-payment', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({ paymentId })
                    ...
                    onReadyForServerCompletion: (paymentId) => {
                        ...
                        // Send paymentId to Vercel serverless function for completion
                        fetch('/api/complete-payment', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({ paymentId })
